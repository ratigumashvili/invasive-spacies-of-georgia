...
export function CalendarItem({ slug, startDate, endDate, startMonth, endMonth, year, title, location }: EventItem) {
    ...
    return (
        <div className="flex gap-2 mb-4">
            <div className="w-[100px] min-w-[100px] flex flex-col mb-4 relative overflow-hidden rounded-md">
                ...
                <div className="flex-1 bg-sky-950 text-white text-center p-1 pt-3">
                ...
                <div className="bg-slate-300 text-center p-1">{year}</div>
            </div>
            <div>
